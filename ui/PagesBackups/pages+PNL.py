    ...
    with container:
        ...
        with ui.element("div").classes("card"):
            ...
            if not open_trades:
                ...
                <th>Symbol</th><th>Dir</th><th>Status</th><th>Entry</th><th>P/L $</th><th>P/L %</th><th>SL</th><th>TP1</th><th>TP2</th><th>Size $</th><th>Opened</th><th>Details</th>
                </tr></thead><tbody>"""
                for t in open_trades:
                    ...
                    tbl += f"""<tr>
                      ...
                      <td class="mono text-success">{fmt_price(t.take_profit_1 or 0)}</td>
                      <td class="mono text-success">{fmt_price(t.take_profit_2 or 0)}</td>
                      <td class="mono tabular-nums">{fmt_money_short(t.position_size_usd or 0)}</td>
                      <td class="mono text-muted">{t.created_at.strftime("%m/%d %H:%M") if t.created_at else "—"}</td>
